...
const handleTogglee = e => {
  ...
  <ul className="dropdown-content bg-base-100 rounded-box z-[1] w-52 p-2  mt-10">
    ...
    <li><a className="flex gap-4 items-center mt-4"><FaPlus />Add Account</a></li>
        ...
        <div>
          <hr className="mt-8" />
          <h1 className="flex items-center gap-8"><CgProfile className="text-2xl"/>My Profile </h1>
          <hr className="mt-4"/>
          ...
          <hr className="mt-8"/>
          <h1 className="flex items-center gap-8"><FaUserFriends    className="text-2xl"/>Invite Friends</h1>
